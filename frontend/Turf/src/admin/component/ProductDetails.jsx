...
<img src={`https://turf-project-04az.onrender.com/opt/render/project/src/backend/routes/uploads/images/${val.image}`} style={{width:"100%",height:"80vh"}} className='img-fluid'/>
