...
const handleClick=()=>{
  ...
  const handleImage=(e)=>{
    ...
    try{
      const uploadprofile=fetch("https://turf-project-ecru.vercel.app/api/profile",{
        method:"POST",
        body:formdata
