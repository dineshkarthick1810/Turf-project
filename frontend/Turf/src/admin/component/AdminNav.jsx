...
const handleClick=()=>{
  ...
  const handleImage=(e)=>{
    ...
    try{
      const uploadprofile=fetch("http://localhost:3002/api/profile",{
        method:"POST",
        body:formdata
