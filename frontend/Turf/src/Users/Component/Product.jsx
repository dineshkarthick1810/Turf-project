                        ...
                        return <div>
                            <div className='row mt-5 '   >
                                <div className='col-md-4'>
                                    <img src={`https://turf-project-04az.onrender.com/opt/render/project/src/backend/routes/uploads/images/${val.image}`} className='img-fluid' style={{ borderRadius: "10px" }} />
                                </div>
...
{filteredReviews.map((res,index)=>{
    ...
    <img src={`https://turf-project-04az.onrender.com/opt/render/project/src/backend/routes/uploads/images/${res.profile}`} style={{height:"60px",width:"60px",borderRadius:"50%",backgroundSize:"cover"}} />
