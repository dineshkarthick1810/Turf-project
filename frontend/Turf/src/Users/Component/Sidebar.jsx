...
const handleImage=async(e)=>{
  ...
  try{
    const uploadProfile=await fetch("https://turf-project-ecru.vercel.app/api/profile",{
      method:'POST',
      body:formdata
