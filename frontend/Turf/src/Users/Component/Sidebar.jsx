...
const handleImage=async(e)=>{
  ...
  try{
    const uploadProfile=await fetch("http://localhost:3002/api/profile",{
      method:'POST',
      body:formdata
